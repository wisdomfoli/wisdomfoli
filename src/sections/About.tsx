export default function About() {
  return (
    <section id="about" className="animate-section text-black py-16 px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Card 1 - Mon Parcours */}
          <div className="animate-card bg-gray-50 rounded-lg p-8 border border-gray-200">
            <h2 className="text-2xl font-bold mb-6 text-[#96031A]">
              My Journey
            </h2>
